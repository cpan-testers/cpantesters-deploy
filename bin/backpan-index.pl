#!/usr/bin/env perl
#
# This is for the BackPAN::Index dist, _not_ BackPAN::Index::Create which has a
# bin script "create-backpan-index".
#
# Copied from https://github.com/book/BackPAN-Index/blob/master/create_backpan_index.pl
# because the dist doesn't seem to install the script anywhere.
